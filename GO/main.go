...
func strtointsplice(s string) [][]int {
	...
	for i := 0; i < len(rows)-1; i++ { // ICI IMPORTANT : -1 car je regarde pas la derniere ligne, forcément parce que c nul fait pas parti matrice
